...
class ComputedStyleBaseWriter(make_style_builder.StyleBuilderWriter):
    def __init__(self, json5_file_paths):
        ...
        _evaluate_all_properties_layerize(all_properties, json5_file_paths[3], 3, [0.1, 0.4, 1.0])  # subjected to change
        _evaluate_inherit_properties(all_properties, json5_file_paths[3], 2, [0.3, 1.0])
